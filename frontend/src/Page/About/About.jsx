            ...
            <section className={style.value}>
                ...
                <div className={style.container}>
                    ...
                    <div data-aos="fade" className={style.one}>
                        <img style={{ width: '60%' }} src={value} alt="" />
                        <h1>Our Value</h1>
                    </div>
                    ...
                    <div data-aos="fade-up" className={style.two}>
                        <ul>
                            ...
                            <li>Quality: What we do, we do very well.</li>
                            <li>Integrity: Be real without compromise.</li>
                            <li>Trust: Building the trust with customers and partners is a must to have.</li>
